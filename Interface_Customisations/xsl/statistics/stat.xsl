...
-->
			...
			<br/>
					...
					<br/>
								<a href="javascript:injectServiceResponse('stat.tableExport?tableToExport=all_records_ea','stat.tableExportDiv')">
							Download all EA records (caution takes a while!)</a>&#160;
