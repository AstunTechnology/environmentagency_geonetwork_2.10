		...
		<xsl:call-template name="formLayout">
			...
			<xsl:with-param name="content">
				...
				<xsl:with-param name="buttons">
					...
					<p style="text-align: left">If you are unable to login, your account may be locked. Please contact the <a><xsl:attribute name="href">mailto:open@defra.gsi.gov.uk</xsl:attribute><xsl:value-of select="root/site"/> helpdesk at open@defra.gsi.gov.uk</a>.</p>
				</xsl:with-param>
		</xsl:call-template>
